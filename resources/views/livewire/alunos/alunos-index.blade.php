...
<div>
    ...
    <div class="flex flex-row justify-between">
        ...
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Alunos(as)</h2>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center text-sm">
                                ...
                                <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                    @if ($aluno->url_foto_perfil)
                                        <img
                                        class="object-cover w-full h-full rounded-full"
                                        src="{{\Illuminate\Support\Facades\Storage::disk('public')->url($aluno->url_foto_perfil)}}"
                                        alt=""
                                        loading="lazy"
                                        />
                                    @else
